  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-sm text-sm p-4 items-start">
      <figure className="h-32 flex-shrink-0 overflow-hidden rounded-md">
        <img src={ship.photo_url} alt={ship.name} className="w-full h-full object-cover" />
      </figure>
      <div className="flex-1">
        ...
        <p>
          <strong>TEU:</strong> {ship.min_teu}
        </p>
        <p>
          <strong>LOA:</strong> {ship.loa_m}
        </p>
        <p>
          <strong>Shipyard:</strong> {ship.shipyard}
        </p>
        <p>
          <strong>Year of Built:</strong> {ship.year_built}
        </p>
        <p>
          <strong>Ports:</strong> {ship.last_ports.slice(0, 3).join(', ')}
        </p>
